    ...
    <div class="main-container">
      <div class="list-container">
        <div class="add">
          <v-row class="mb-4">
            <v-col cols="6">
              <v-text-field label="주문번호" v-model="form.number" readonly outlined />
            </v-col>
            ...
            <v-col cols="6">
              <v-text-field label="업체명" v-model="form.client" outlined />
            </v-col>
        ...
        <v-row justify="end">
          ...
          <v-btn color="secondary" @click="exportPdf">PDF 출력</v-btn>
        </v-row>
      </div>
    </div>
...
const breadcrumbs = shallowRef([
  ...
  { title: '주문서등록', disabled: false, href: '#' },
])
</script>
