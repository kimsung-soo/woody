    ...
    <div class="main-container">
      ...
      <div class="form-wrapper">
        <div class="add">
          <v-row class="mb-4">
            <v-col cols="6">
              <v-text-field label="자재코드" v-model="form.matCode" dense outlined />
            </v-col>
            <v-col cols="6">
...
// 제품 리스트
const rowData1 = ref([
  { 자재코드: 1, 자재명: '원목', 자재유형: '원자재', 규격: '660*400*720', 단위: 'EA', 입사일자: '2025-08-29' },
  { 자재코드: 2, 자재명: '합판', 자재유형: '원자재', 규격: '660*400*720', 단위: 'EA', 입사일자: '2025-07-29' },
  { 자재코드: 3, 자재명: '나사', 자재유형: '부자재', 규격: '15', 단위: 'EA', 입사일자: '2025-06-29' },
  { 자재코드: 4, 자재명: '철다리', 자재유형: '부자재', 규격: '660*400*720', 단위: 'EA', 입사일자: '2025-05-29' },
  { 자재코드: 5, 자재명: '볼트', 자재유형: '부자재', 규격: '12', 단위: 'EA', 입사일자: '2025-04-29' },
  { 자재코드: 6, 자재명: '너트', 자재유형: '부자재', 규격: '12', 단위: 'EA', 입사일자: '2025-03-29' }
]);

const colDefs1 = ref([
  { field: '자재코드', editable: true, width: 140 },
  { field: '자재명', width: 140, editable: true },
  { field: '자재유형', width: 140, editable: true },
